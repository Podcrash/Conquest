package me.raindance.champions.disguise;
...
public final class Disguiser {
    ...
    public Disguiser() {
        this.protocolManager = Main.getInstance().getProtocolManager();
    }

    public void disguiserIntercepter(){
        Main.instance.getLogger().info("Disguiser Loaded!");
        /**
        ...
        protocolManager.addPacketListener(new PacketAdapter(Main.instance, ListenerPriority.HIGHEST, types) {
            @Override
